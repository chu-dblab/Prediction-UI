var baseRegisterSystemSingUpUrl = "api/gsat/store";
...
function getRegisterData() {
    ...
    var input_interest = document.getElementById('select-interest-A').value + ";" +
        document.getElementById('select-interest-B').value + ";" +
        document.getElementById('select-interest-C').value;
...
function successDialogAlertMsg(id, text) {
    ...
    alertArea.append('<div data-alert class="alert-box success radius">    ' + text +
...
$('#send-register-btn').click(function (e) {
    ...
    $('#user-input-data-modal').fadeOut('fast');
